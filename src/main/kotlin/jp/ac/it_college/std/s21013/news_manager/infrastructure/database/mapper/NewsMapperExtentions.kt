...
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.record.NewsRecord
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.body
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.categoryId
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.createAt
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.id
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.publishAt
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.title
import jp.ac.it_college.std.s21013.news_manager.infrastructure.database.mapper.NewsDynamicSqlSupport.News.userId
